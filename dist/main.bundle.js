...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _images_threeDots_png__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./images/threeDots.png */ \"./src/images/threeDots.png\");\n/* harmony import */ var _images_checkbox_png__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./images/checkbox.png */ \"./src/images/checkbox.png\");\n/* harmony import */ var _images_enter_jpg__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./images/enter.jpg */ \"./src/images/enter.jpg\");\n/* harmony import */ var _images_trash_png__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./images/trash.png */ \"./src/images/trash.png\");\n/* harmony import */ var _images_completed_png__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./images/completed.png */ \"./src/images/completed.png\");\n\r\n\r\n// eslint-disable-next-line import/no-unresolved, import/no-extraneous-dependencies\r\n\r\n\r\n\r\n\r\nlet tasks = [];\r\n\r\nconst listContainer = document.querySelector('.task-container');\r\n\r\nconst displayList = () => {\r\n  listContainer.innerHTML = '';\r\n  tasks.forEach((task) => {\r\n    const list = document.createElement('li');\r\n    list.classList.add('list');\r\n    list.innerHTML = ` <img class='checkbox' src='${_images_checkbox_png__WEBPACK_IMPORTED_MODULE_2__}'> <p class='task-description'>${task.description}</p> <img class='options' src='${_images_threeDots_png__WEBPACK_IMPORTED_MODULE_1__}'> `;\r\n    listContainer.appendChild(list);\r\n  });\r\n};\r\ndisplayList();\r\nconst submitBtn = document.querySelector('#submitBtn');\r\nconst addInput = document.querySelector('.add');\r\n//const addTask = ()=>\r\nconst getLocalStorage = () => {\r\n  let localTasks = localStorage.getItem('tasks');\r\n  if (localTasks) {\r\n    tasks = JSON.parse(localTasks);\r\n    displayList();\r\n\r\n  }\r\n}\r\ngetLocalStorage();\r\nconsole.log(tasks)\r\nsubmitBtn.addEventListener('click', (e) => {\r\n  e.preventDefault();\r\n  let newTask = {\r\n    description: addInput.value,\r\n    completed: false,\r\n    index: tasks.length\r\n  }\r\n  tasks.push(newTask);\r\n  localStorage.setItem('tasks', JSON.stringify(tasks));\r\n  displayList();\r\n  check();\r\n})\r\n\r\nconst optionBtn = document.getElementsByClassName('options');\r\nconst taskDescription = document.getElementsByClassName('task-description');\r\nconst listElem = document.getElementsByClassName('list');\r\n\r\n\r\nconst checked = document.getElementsByClassName('checkbox');\r\nconst check = () => {\r\n  for (let i = 0; i < optionBtn.length; i++) {\r\n    optionBtn[i].addEventListener('click', () => {\r\n      listElem[i].classList.add('edit')\r\n      listElem[i].innerHTML = `<img class='checkbox' src='${_images_checkbox_png__WEBPACK_IMPORTED_MODULE_2__}'> <input class=\"add\" type=\"text\" value=${taskDescription[i].textContent} > <img class='options' src='${_images_trash_png__WEBPACK_IMPORTED_MODULE_4__}'>`\r\n      \r\n    })\r\n  }\r\n\r\n  for (let i = 0; i < checked.length; i++) {\r\n    checked[i].addEventListener('click', () => {\r\n      checked[i].src = _images_completed_png__WEBPACK_IMPORTED_MODULE_5__;\r\n    })\r\n  }\r\n}\r\ncheck();\r\n\r\n\r\n\r\n\r\n\n\n//# sourceURL=webpack://to-do-list/./src/index.js?");
